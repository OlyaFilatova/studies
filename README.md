...
- [Classification](/classification/README.md) - Test task: Explores classification models (Random Forest, CNN, FNN) using the publicly available [MNIST](https://www.kaggle.com/datasets/hojjatk/mnist-dataset) dataset
